                                ...
                                >
                                    ...
                                    <div className="mt-4 flex-grow">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            {prod.techniques && prod.techniques.length > 0
                                                ? formatText(prod.techniques[0])
                                                : 'No technique specified'
                                            }
                                            {prod.techniques && prod.techniques.length > 1 &&
                                                ` +${prod.techniques.length - 1} more`
                                            }
                                        </p>
                                    </div>
                          ...
                          .replace('Bs', 'Bs.')}
                                    ...
                                    {expanded && (
                                        <div className="mt-3 bg-gray-100 rounded-lg p-3 text-sm text-black border border-gray-200">
                                            <p><strong>Techniques:</strong> {prod.techniques ? prod.techniques.map(formatText).join(', ') : 'N/A'}</p>
                                            <p><strong>Categories:</strong> {prod.categories ? prod.categories.map(formatText).join(', ') : 'N/A'}</p>
                                            <p><strong>Status:</strong> {prod.status}</p>
                                            <p className="mt-2 text-gray-700 italic">{prod.description || 'No description.'}</p>
                                        </div>
                                    )}
                                </div>
                            );
