...
// Actualizado para manejar arrays de técnicas y categorías
async function createProduct({
                                 sellerId,
                                 name,
                                 techniques, // Cambiado de technique a techniques (array)
                                 categories, // Cambiado de category a categories (array)
                                 materials,
                                 description,
                                 price,
                                 stock,
    ...
    const res = await fetch(`${API_URL}/products`, {
        ...
        body: JSON.stringify({
            sellerId,
            name,
            techniques, // Enviar como array
            categories, // Enviar como array
            materials,
            description,
            price,
            stock,
